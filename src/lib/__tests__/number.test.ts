...
describe('src/lib/number', function() {
	describe('case', function() {
		it('should use zero case if the last digit of the number is 0 or more than 5', function() {
		...
		it('should use one case if the last digit of the number is 1', function() {
			expect((1).case('дней', 'день', 'дня')).toEqual('день');
			expect((21).case('дней', 'день', 'дня')).toEqual('день');
		});

		it('should use two case if the last digit of the number is between 2 and 4', function() {
		...
		it('should use zero case if two last digits of number are between 10 and 20', function() {
	...
	describe('pad', function() {
		it("should add zeros to the left part until it's length is equal required", function() {
			expect((100.5).pad(5)).toEqual('00100.5');
		});

		it("should add zeros to the right part until it's length is equal required", function() {
			expect((100.5).pad(0, 3)).toEqual('100.500');
		});

		it('should turn integer into float if right zeros are required', function() {
